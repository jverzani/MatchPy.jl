...
# cf. https://raw.githubusercontent.com/JuliaSymbolics/SymbolicIntegration.jl/refs/heads/main/src/methods/rule_based/rule2.jl
"""
...
#        printdb(4, "defslot failed also with the modified match :(")
    ...
    if rule.args[1]===:^
        ...
        fad = SymsType[]
        is1divsmth = (operation(data) === /) && _isone(arg_data[1])
...
#XXX            !Base.invokelatest(eval(pred),unwrap_const(value_matched)) && return FAIL_DICT
